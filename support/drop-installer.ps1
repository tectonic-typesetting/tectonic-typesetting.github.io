...
insert the latest version number into the PowerShell script below.
{%- endcomment -%}

# This file is STRONGLY derived from `www/fetch-zip.tmpl.ps1` from
# https://github.com/pkgw/cranko/, which in turn is strongly derived from
# `install.ps1`, used by the Chocolatey project:
#
...
#
#   chocolateyIgnoreProxy chocolateyProxyLocation chocolateyProxyUser
#   chocolateyProxyPassword chocolateyUseWindowsCompression


$version = "{{ site.latest }}"
$arch = "x86_64-pc-windows-msvc"
$base = "tectonic-$version-$arch.zip"
$url = "https://github.com/tectonic-typesetting/tectonic/releases/download/tectonic@$version/$base"
...
# Download the Zip
Write-Output "tectonic(drop-installer.ps1): downloading version $version for architecture $arch"
